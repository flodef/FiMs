  ...
  GLOBAL.investmentFormula = "Investment!A:AL";
  ...
  function updateInvestmentTable(id, contents) {
    ...
    for (var i = 0; i < row; ++i) {
      ...
      for (var j of [7, 10, 12, 14, 18, 19, 22, 32, 23, 29, 33, 36]) {   // Select only the interesting columns
        ...
        // Avg price = 33, Avg gap = 34, Avg lm price = 36, Avg lm progress = 37
        var con =  i == 0 || j != 12
                    ? i == 0 || j < 23 || j == 32
                      ? contents[i][j]
