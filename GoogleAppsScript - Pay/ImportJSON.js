/* exported ImportJSON, ImportJSONViaPost, ImportJSONFromSheet,
ImportJSONBasicAuth, URLEncode, AddOAuthService__ */
/* global UrlFetchApp, Utilities, SpreadsheetApp, Logger */
...
function ImportJSONAdvanced(url, fetchOptions, query, parseOptions, includeFunc, transformFunc) {
  var jsondata = UrlFetchApp.fetch(url.trim(), fetchOptions);
 ...
 */
function applyXPathRule_(rule, path) {
