...
class Run {
  ...
  getSheetValues(range) {
    this.contents = this._getData(range);
    this.errMsg = "";
    if (!this.errMsg) {
  ...
  setSheetValues(range, values) {}
  clearSheetValues(range) {}
  ...
  _getData(range) {
    ...
    // GLOBAL.investmentFormulae = "Investment!D:AD";
    ...
    switch (range) {
      ...
      case GLOBAL.dashboardFormulae:
        ...
        break;
      case GLOBAL.investmentFormulae:
        ...
        ["iShares USD Treasury Bond 20+yr UCITS ETF", "Long term US bonds (20-25 year)", "40.0%", "0.20%", "LON", "LN", "73,288", "$4.54", "3.9755 €", "280,330.24 €", "291,355.10 €", "285,831.35 €", "-15,328.90 €", "4", "-1390", "-5,525.92 €", "-3.98 €", "0.27%", "SELL (0.27%)", "2,438.65 €", "0.84%", "2,086.02 €", "0.74%", "11,024.86 €", "3.93%", "13,110.88 €", "4.68%", "3.09 €"],
        ["Vanguard S&P 500 UCITS ETF", "Stocks", "30.0%", "0.07%", "AMS", "NA", "5,365", "", "39.954 €", "237,279.71 €", "214,353.21 €", "214,373.51 €", "18,849.26 €", "0", "0", "0.00 €", "-39.95 €", "-2.26%", "MID (-2.26%)", "-7,344.69 €", "-3.31%", "2,027.24 €", "0.85%", "-22,926.50 €", "-9.66%", "-20,899.26 €", "-8.81%", "0.00 €"],
        ["iShares USD Treasury Bond 7-10yr UCITS ETF USD Dist", "Intermediate US bonds (7-10 year)", "15.0%", "0.20%", "AMS", "NA", "655", "", "166.99 €", "104,617.95 €", "109,378.45 €", "107,186.76 €", "-4,160.00 €", "3", "-13", "-2,170.87 €", "0.00 €", "0.17%", "SELL (0.17%)", "366.80 €", "0.34%", "1,860.88 €", "1.78%", "4,760.50 €", "4.55%", "6,621.38 €", "6.33%", "0.00 €"],
        ["ETFS All Commodities", "Commodities", "7.5%", "0.49%", "EPA", "FP", "7,901", "", "6.959 €", "58,421.84 €", "54,983.06 €", "53,593.38 €", "1,876.04 €", "2", "0", "0.00 €", "0.00 €", "-0.61%", "MID (-0.61%)", "-355.54 €", "-0.64%", "0.00 €", "0.00%", "-3,438.78 €", "-5.89%", "-3,438.78 €", "-5.89%", "0.00 €"],
        ["ETFS Physical Gold", "Gold", "7.5%", "0.39%", "AMS", "NA", "517", "", "105.78 €", "53,354.68 €", "54,688.26 €", "53,593.38 €", "-2,104.80 €", "1", "-10", "-1,057.80 €", "0.00 €", "0.25%", "SELL (0.25%)", "180.95 €", "0.33%", "0.00 €", "0.00%", "1,333.58 €", "2.50%", "1,333.58 €", "2.50%", "0.00 €"],
      ...
      case GLOBAL.historicFormulae:
        ...
        break;
      default:
      // GLOBAL.resultFormulae
      // GLOBAL.accountFormulae
      // GLOBAL.expHistoFormulae
